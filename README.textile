...
Em vez de duplicar sempre o mesmo trabalho, porque não criar uma base?
...
* TODO *
* Drag and drop com ordenação para a secção das páginas no admin
* Suporte total i18n
